...
struct HomeView: View {
    ...
    let menuItems = ["Organisation", "Inspiration", "Dienstleister", "Trauzeugen", "Gadgets", "Nice to know", "Getting Ready", "No-Go's", "Infos für Fotografen"]
            ...
            VStack(spacing: 20) {
                ...
                LazyVGrid(columns: [
                    ...
                    Button(action: {
                        ...
                        Text(menuItems[4]).menuItemStyle(lineLimit: 2)
                    ...
                    NavigationLink(isActive: $navigationTimeLineIsActive, destination: { TimeLineView() }, label: {
                        EmptyView()
                    })
                    
                    NavigationLink(isActive: $navigationGuestListIsActive, destination: { GuestListView() }, label: {
                        EmptyView()
                    })
                }
            }
